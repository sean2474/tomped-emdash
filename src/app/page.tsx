        ...
        <div className={styles.competitionDetail2Container}>
          ...
          <div className={styles.buttonContainer}>
            <div className={styles.button} ref={addChildRef(4)}>
              <Button href='/file/TOMPED_안경테_디자인_공모전_신청서.docx' download="TOMPED_안경테_디자인_공모전_신청서.docx"> 신청서 다운로드 </Button>
            </div>
            <div className={styles.button} ref={addChildRef(4)}>
          ...
          <div className={styles.descriptions}>
            <div className={styles.itemBox+" "+styles.hidden} ref={addChildRef(6)}>
              ...
              <div className={styles.button}>
                <Button href='/file/TOMPED_안경테_디자인_공모전_신청서.docx' download="TOMPED_안경테_디자인_공모전_신청서.docx"> 다운로드 </Button>
              </div>
            </div>
            <div className={styles.itemBox+" "+styles.hidden} ref={addChildRef(6)}>
              <div className={styles.subtitle}>
